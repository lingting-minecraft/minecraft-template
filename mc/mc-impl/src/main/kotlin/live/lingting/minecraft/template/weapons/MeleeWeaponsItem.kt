...
import live.lingting.minecraft.util.WeaponsUtils.speedFromInterval
...
class MeleeWeaponsItem : IMeleeWeaponsItem {
    ...
    constructor(p: Properties) : super(MeleeWeaponsItem::class.java, 3.0, speedFromInterval(1.5), 12, p)
