...
import live.lingting.minecraft.block.BlockStatePredicates.ALWAY_FALSE
import live.lingting.minecraft.block.BlockStatePredicates.ALWAY_TRUE
import live.lingting.minecraft.block.IWallBlock
 ...
 */
class PanelNodeWallBlock : IWallBlock {

    companion object {

        @JvmField
        val ID = BlockSource.id("panel.node.wall")
